...
Deno.serve(async (req) => {
  ...
  if (payload.record.invited_users.includes(',')) {
    pole = payload.record.invited_users.split(',');
    ...
    body: JSON.stringify({
      message: {
        ...
        notification: {
          ...
          body: `${payload.record.creator} invited you to the game ${payload.record.game}`
        }
      }
    })
  }
